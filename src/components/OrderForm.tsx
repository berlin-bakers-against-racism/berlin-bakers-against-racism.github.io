        ...
        <Grid container>
          <Grid item xs={12}>
            <Typography variant="body1">
              <p>Hi Berliners!</p>
              <p>Together with 20+ bakers in the city, Berlin Bakers Against Racism is hosting a bake sale
              to raise funds to fight against systemic racism. 100% proceeds donated to
                ...
                &nbsp;<Link href="https://kop-berlin.de/" target="_blank" rel="noopener">KOP-Berlin</Link>.</p>
              <p>Bake sale is now open and taking orders until end-of-day Wednesday 17. June. Contribute to the fight for justice
                AND satisfy your sweet tooth! Limited goods available - so hurry before they’re gone!</p>
              <p>Bakers Against Racism is an initiative started in the US by
                ...
                to fight for justice. Their initiative is now in 15 countries world-wide including here in Berlin!</p>
            </Typography>
            <br />
            <p>
              <Typography variant="body1">
